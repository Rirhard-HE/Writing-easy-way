...
- 观察到 `CHR_0001` 已苏醒、能自主呼吸、能回应，并存在运动迟滞。
- 声称科隆诺系统当前把 `CHR_0001` 分类为资产；该项为 `L3_ORGANIZATION_MODEL / TEXT_CONFIRMED_STATEMENT`。
- 展示并解释 `FAC_0001` 的账单、三项标准方案、匿名内部记录及 `SYS_0003` 操作术语；均保持 `L3_ORGANIZATION_MODEL`。
- 以 `L4_CHARACTER_KNOWLEDGE` 讲述自己亲眼见过一名反复投入战斗的负债者逐步恶化，直至系统改变资产价值判断。
...
- 正文没有证明其知道或能认证 `CHR_0001` 的客观身份连续性。
