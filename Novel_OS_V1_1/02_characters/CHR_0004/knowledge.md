...
- 何筠失联七个月后返回诺瓦尔。
- 失联期间家庭经历企业催收、调查、保险核查与长期失踪/遗产认定压力。
- 何筠获得一个科隆诺遗迹探险工作选择，有舰队、工程支援、员工级待遇和前置训练；他预计还会离开，但尚未签约。
- 知道何筠仍只是科隆诺遗迹事务工作的条件候选，并未获得正式编制。
- `CH_0011` 听何筠说明未接受要约还包含债务暂停计息，任务所需舰船、设备和训练资源由项目体系提供，并可能承担任务区航行/现场处置层面的战术职责；知道这些仍未生效。
...
- 知道何筠 `CH_0011` 睡到接近午段才醒且精神、食欲不错；不知道其梦境内容或恢复原因。

## 明确不知道

- 何筠的复苏过程、客观身份连续性、记忆状态、异常模型、遗迹位置与完整风险。
- `CH_0010` 梦境内容、`SYS_0003` 作者级机制、梦后恢复是否存在异常因果。
