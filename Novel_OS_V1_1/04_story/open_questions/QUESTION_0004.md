...
日志发送者所称的大崩裂前遗迹在哪里、是什么，以及如何再次找到？

## Why it matters

该问题驱动 `FAC_0002` 对何筠的特殊项目邀约，并连接身份记忆与旧联邦技术线索。
...
- `LOC_0003` 是 `FAC_0001` 前身在 214 年前开启的已知历史遗址，位于 `LOC_0002` 广义区域；它被明确区分于当前残留航道所指的未知遗迹。

## Affected IDs / chapters

- `CHR_0001`、`CHR_0002`、`FAC_0001`、`FAC_0002`、`FAC_0004`、`FAC_0006`、`LOC_0002`、`LOC_0003`、`SYS_0005`、`EVT_000003`、`EVT_000004`、`EVT_000005`、`CH_0002`、`CH_0003`、`CH_0004`。

## Decisions that must wait

- 遗迹位置、性质、进入方式与再次定位方法需作者明确决定与揭示批准。
